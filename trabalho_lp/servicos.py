...
servicoReg = namedtuple("servicoReg", "id, serviço, preco")
listaServicos = []
...
def pesquisar_servico():
    cod = input("Qual o codigo do serviço a pesquisar? ")
...
def eliminar_servico():
    cod = input ("Código do Serviço a eliminar --> ")
    pos = encontrar_posicao(cod)
...
def alterar_servico():
    cod = input ("Código do Serviço a alterar --> ")
    pos = encontrar_posicao(cod)
